        ...
        Column (modifier = Modifier
            ...
            Column (modifier = Modifier
               ...
               Row (modifier = Modifier
                   ...
                   Text(text = "Hoang Long", fontSize = 20.sp, fontWeight = FontWeight(700), fontFamily = FontFamily(
                ...
                Column (modifier = Modifier.padding(start = 15.dp)){
                    Text(text = "25 Trinh Van Bo, Nice, 06200, Côte", color = Color.Gray, fontSize = 15.sp, fontFamily = FontFamily(
                        Font(R.font.nunitosans_7pt_condensed_bold)
